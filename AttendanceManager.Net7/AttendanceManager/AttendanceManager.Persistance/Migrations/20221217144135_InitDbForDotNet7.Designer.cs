...
namespace AttendanceManager.Persistance.Migrations
{
    ...
    [Migration("20221217144135_InitDbForDotNet7")]
    partial class InitDbForDotNet7
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttendanceManager.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = new Guid("c7fd9faf-5c33-49f4-b6dd-ba5e3f3708d0"),
                            AccountConfirmed = false,
                            Code = "-",
                            Created = new DateTime(2022, 12, 17, 16, 41, 35, 659, DateTimeKind.Local).AddTicks(1758),
                            Email = "admin@admin.ro",
                            EnrollmentYear = 2022,
                            FullName = "Administrator",
                            Password = "system123",
                            Role = 0,
                            Updated = new DateTime(2022, 12, 17, 16, 41, 35, 659, DateTimeKind.Local).AddTicks(1824)
                        });
                });
